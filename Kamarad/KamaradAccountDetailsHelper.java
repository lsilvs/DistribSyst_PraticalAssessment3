...
abstract public class KamaradAccountDetailsHelper
{
  ...
  public static Kamarad.KamaradAccountDetails read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.unique_id = istream.read_string ();
    value.name = istream.read_string ();
    value.phone_number = istream.read_string ();
    value.address = istream.read_string ();
    value.bank_number = istream.read_long ();
    value.balance = istream.read_float ();
    value.kamarad_credit = istream.read_float ();
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, Kamarad.KamaradAccountDetails value)
  {
    ostream.write_string (value.unique_id);
    ostream.write_string (value.name);
    ostream.write_string (value.phone_number);
    ostream.write_string (value.address);
    ostream.write_long (value.bank_number);
    ostream.write_float (value.balance);
    ostream.write_float (value.kamarad_credit);
  }
