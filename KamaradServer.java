...
public class KamaradServer{
	...
	public static void main (String args[]) {
		try{
			...
			KamaradOnlinePOA kamaradRef = new KamaradOnlinePOATie(new KamaradServant());
			...
			*/
			...
			byte[] objID = rootPOA.activate_object(kamaradRef);
			/**
			...
			*/
			...
			NamingContext ContextCtx = rootCtx.bind_new_context(nc);
			System.out.println("Context Kamarad added to Name Space.");

			nc[0] = new NameComponent("KamaradOnLine", "Object");
			ContextCtx.rebind(nc, ServantObjectRef);
			System.out.println("Object KamaradOnLine added to Kamarad Context.");
